      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="mt-8 text-center space-y-3 animate-fade-in">
          <a
            ...
            className="inline-flex items-center space-x-2 text-[#8B7355] hover:text-purple-600 transition-colors text-sm font-medium"
          >
          ...
          <div className="text-[#8B7355]/40">|</div>
          <a
            href="/user/access"
            className="inline-flex items-center space-x-2 text-[#8B7355] hover:text-green-600 transition-colors text-sm font-medium"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
