    ...
    <div className="min-h-screen theme-user flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-5xl">
        ...
        <div className="text-center mb-16 animate-fade-in spacing-section">
          ...
          <h1 className="text-5xl md:text-6xl font-semibold text-text mb-4">Pic_cul</h1>
          <p className="text-xl md:text-2xl text-text font-medium">店舗メニュー管理システム</p>
          <p className="text-base text-text-light mt-2 font-medium">美味しい管理を、もっと簡単に</p>
        </div>
